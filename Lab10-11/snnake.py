...
LEFT = (-1, 0) 
RIGHT = (1, 0)
font = pg.font.Font('lab10-11/papka/Oswald.ttf', 30)
clock = pg.time.Clock()
...
class Game:
    ...
    def get_level_walls(self, level):
        ...
        if level == 1:
            walls = [
                pg.Rect(200-20, 400, 200+20, 20),  # Пример стены
                pg.Rect(200-20, 200, 200+20, 20)
            ]
        elif level == 2:
            # Стены для уровня 2
            walls = [
                pg.Rect(200-20, 400, 200+20, 20),  # Пример стены
                pg.Rect(200-20, 200, 200+20, 20),
                pg.Rect(200-20, 320+20, 20, 80),  # Пример стены
                pg.Rect(200-20, 200, 20, 80),
                pg.Rect(400, 320+20, 20, 80),  # Пример стены
                pg.Rect(400, 200, 20, 80)
            ]
        elif level >= 3:
            # Стены для уровня 3
            walls = [
