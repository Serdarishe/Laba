...
class Coin(pg.sprite.Sprite):
    def __init__(self):
        ...
        if not game_over:
            ...
            self.image = pg.transform.scale(self.image,(60,60)) #menyaem ego na podhodyashi nam razmer
...
class Car(pg.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.orig_image = pg.image.load('lab8/car.png')#zagruzhaem
...
while True:
    ...
    if sobrannye_monety:
        ...
        new_coin = Coin()#posle dokill u nas propadaut monety nam nuzhny novye
        coins.add(new_coin)
...
#fon dlya sheta
    ...
    if cargo.cnthp == 0 and not game_over:
        pg.mixer.Sound('lab8/lose.mp3').play()
        game_over = True
